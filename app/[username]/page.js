    ...
    <div className="bg-gray-100 min-h-screen">
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row">
        ...
        <div
          ...
          } h-full w-full md:w-[85%] -translate-x-1/2 bg-white text-lg rounded-t-xl duration-500 pt-7 pb-10`}
        >
          <div className="h-full overflow-y-scroll overflow-x-hidden p-10">
            <div className="max-w-4xl mx-auto">
              {/* <div>
                ...
                <div className="p-10 bg-gray-100 mt-10 rounded-3xl">
                  <p className="text-2xl">
                    Familiar as iPhone. You’ll feel right at home on Mac, with
                    many of the same apps as iPhone — like Messages, Photos,
                    Notes, and FaceTime.
                  </p>
              ...
              {opened === 1 && (
                <div>
                  ...
                  <p className="text-xl md:text-3xl font-medium text-gray-500">
                    <span className="text-black">Converted</span> this landing
                    page from <span className="text-black">figma</span>
                  </p>
                  <br />
              ...
              {opened === 2 && (
                <div>
                  ...
                  <p className="text-xl md:text-3xl font-medium text-gray-500">
                    <span className="text-black">Converted</span> this landing
                    page from <span className="text-black">figma</span>, added
                    checkout
                  </p>
              ...
              {opened === 3 && (
                <div>
                  ...
                  <Safari src="/group107/107group-1.png" alt="" />
                  <br />
                  <p className="text-xl md:text-3xl font-medium text-gray-500">
                    <span className="text-black">Task details</span>
                  </p>
                  <Safari src="/group107/107group-2.png" alt="" />
                  <br />
                  <p className="text-xl md:text-3xl font-medium text-gray-500">
                    <span className="text-black">Developed</span> this drag &
                    drop kanban board
                  </p>
                  <Safari src="/group107/107group-3.png" alt="" />
                </div>
              )}
              ...
              {opened === 4 && (
                <div>
                  ...
                  <br />
                  <p className="text-xl md:text-3xl font-medium text-gray-500">
                    <span className="text-black">A</span> faster to integrate
                    and Easy to maintain cart plugin for your website.
                  </p>
                  ...
                  <br />
                  <p className="text-xl md:text-3xl font-medium text-gray-500">
                    <span className="text-black">Customize</span> your theme as
                    you wish
                  </p>
              ...
              {opened === 6 && (
                <div>
                  ...
                  <br />
                  <Safari src="/didirp/1.png" />
                  <br />
                  <br />
                  <Safari src="/didirp/2.png" />
                  <br />
                  <br />
                  <Safari src="/didirp/3.png" />
                  <br />
                  <br />
